...
SCREENSHOT_DIR = Path("/Users/zhangdongfang/.openclaw/workspace-in3bot/skills/company-due-diligence/reports/due-diligence/screenshots")
REPORT_DIR = Path("/Users/zhangdongfang/.openclaw/workspace-in3bot/skills/company-due-diligence/reports/due-diligence")
...
def main():
    ...
    if not skip_pdf:
        print(f"\n📄 正在生成PDF报告...")
        pdf_file = generate_pdf(md_file, company_name)
